...
export const SAMPLE_WORKFLOW: WorkflowDefinition = {
  states: {
    start1: {
      type: "start",
      attr: { x: 80, y: 130, width: 48, height: 48 },
      props: { name: { value: "start1" }, displayName: { value: "开始" } },
    },
    apply: {
      type: "task",
      attr: { x: 230, y: 128, width: 120, height: 52 },
      text: { text: "请假申请" },
      props: {
        name: { value: "apply" },
    ...
    decision1: {
      type: "decision",
      attr: { x: 450, y: 130, width: 48, height: 48 },
      props: {
    ...
    end1: {
      type: "end",
      attr: { x: 650, y: 130, width: 48, height: 48 },
      props: { name: { value: "end1" }, displayName: { value: "结束" } },
    },
  },
  paths: {
    transition1: {
